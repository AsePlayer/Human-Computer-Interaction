...
public class SpaceInvadersNavigation : MonoBehaviour
{
    public GameObject player, pointer, enemy, game;
    ...
    void TaskOnClick_Return()
    {
        ...
        game.GetComponent<SpaceInvaderController>().paused = false;
    }
    ...
    void Update()
    {
        if (OVRInput.Get(OVRInput.Button.Start, OVRInput.Controller.LTouch) && activated == false)
        {
            ...
            game.GetComponent<SpaceInvaderController>().paused = true;
        }
